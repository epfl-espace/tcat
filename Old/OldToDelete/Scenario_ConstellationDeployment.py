...
class Scenario:
    ...
    def create_launch_vehicle(self, fleet, launch_vehicle_id, launcher, insertion_orbit, serviceable_sats_left,
        ...
        Return:
            (Fleet_module.KickStage): created launcher
        """
        ...
        reference_launch_vehicle = KickStage(launch_vehicle_id, launcher, insertion_orbit, rideshare=rideshare,
    ...
    def define_launcher_mission_profile(self, launcher, precession_direction):
        ...
        Args:
            launcher (Fleet_module.KickStage): launcher to which the profile will be assigned
