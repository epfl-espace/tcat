...
params = {
    ('mission_configuration', 'Mission Configuration'): [
        ...
        ['select', 'text', 'prop_type', 'Propulsion type', 'electrical', ['electrical', 'water', 'mono-propellant', 'solid', 'bi-propellant']],
    ...
    ('constellation_configuration', 'Constellation Configuration'): [
        ...
        ['input', 'number', 'target_mass', 'Satellite Mass (kg)', 100, [0.1, 99999.9]],
        ['input', 'number', 'target_volume', 'Satellite Volume (m^3)', 1, [0.1, 99999.9]],
    ...
    ('orbits_configuration', 'Orbits Configuration'): [
        ['input', 'number', 'a_client_insertion', 'Orbit height of clients insertion orbit (km)', 400.0, [100.0, 40000.0]],
        ['input', 'number', 'ecc_client_insertion', 'Eccentricity of clients insertion orbit', 0, [0.0, 1.0]],
        ['input', 'number', 'inc_client_insertion', 'Inclination of clients insertion orbit (deg)', 90.0, [-90.0, 90.0]],
        ['input', 'number', 'a_client_operational', 'Orbit height of clients operational orbit (km)', 400.0, [100.0, 40000.0]],
        ['input', 'number', 'ecc_client_operational', 'Eccentricity of clients operational orbit', 0, [0.0, 1.0]],
        ['input', 'number', 'inc_client_operational', 'Inclination of clients operational orbit (deg)', 90.0, [-90.0, 90.0]],
        ['input', 'number', 'a_launcher_insertion', 'Orbit height of launchers insertion orbit (km)', None, [100.0, 40000.0]],
        ['input', 'number', 'ecc_launcher_insertion', 'Eccentricity of launchers insertion orbit', None, [0.0, 1.0]],
