...
constellation_mission_params = {
    ...
    ('kickstage', 'Kickstage'): [
        ...
        ['input', 'number', 'kickstage_prop_thrust', 'Prop thrust (N)', None, [0.0, 9999999.0]],
        ['input', 'number', 'kickstage_prop_isp', 'Prop isp (s)', None, [0.0, 9999999.0]],
        ['input', 'number', 'kickstage_propulsion_dry_mass', 'Propulsion dry mass (kg)', None, [0.0, 9999999.0]],
        ['input', 'number', 'kickstage_dispenser_dry_mass', 'Dispenser dry mass (kg)', None, [0.0, 9999999.0]],
        ['input', 'number', 'kickstage_struct_mass', 'Struct mass', 0.0, [0.0, 9999999.0]],
        ['select', 'text', 'kickstage_propulsion_type', 'Propulsion type', None, ['mono-propellant', 'water', 'solid', 'bi-propellant', 'electrical']],
    ],
    ('servicer', 'Servicer'): [
