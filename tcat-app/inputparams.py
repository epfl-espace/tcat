...
params = {
    ...
    ('orbits_configuration', 'Orbits Configuration'): [
        ['input', 'number', 'apogee_sats_insertion', 'Orbit height of clients insertion orbit (km)', 600.0, [100.0, 40000.0]],
        ['input', 'number', 'perigee_sats_insertion', 'Eccentricity of clients insertion orbit', 450.0, [100.0, 40000.0]],
        ['input', 'number', 'inc_sats_insertion', 'Inclination of clients insertion orbit (deg)', 87.4, [-90.0, 90.0]],
        ['input', 'number', 'apogee_sats_operational', 'Orbit height of clients operational orbit (km)', 1200.0, [100.0, 40000.0]],
        ['input', 'number', 'perigee_sats_operational', 'Eccentricity of clients operational orbit', 1200.0, [100.0, 40000.0]],
        ...
        ['input', 'number', 'perigee_launcher_insertion', 'Eccentricity of launchers insertion orbit', 400.0, [100.0, 40000.0]],
        ['input', 'number', 'inc_launcher_insertion', 'Inclination of launchers insertion orbit (deg)', 87.0, [-90.0, 90.0]],
        ['input', 'number', 'apogee_launcher_disposal', 'Apogee launcher disposal', 400.0, [0, 40000.0]],
        ['input', 'number', 'perigee_launcher_disposal', 'Perigee launcher disposal', 50.0, [50.0, 40000.0]],
        ['input', 'number', 'inc_launcher_disposal', 'Inclination launcher disposal', 87.0, [-90.0, 90.0]],
    ]
}
