...
class CommunicationModule(GenericModule):
    ...
    def compute_reference_power(self, plan):
        ...
        # otherwise apply adequate model if available
            ...
            raise TypeError('Missing Communication power model for group '+self.servicer.group+' .')
    ...
    def compute_dry_mass(self, plan):
        ...
        # otherwise apply adequate model if available
            ...
            raise TypeError('Missing Communication mass model for group '+self.servicer.group+' .')
    ...
    def get_recurring_cost(self):
        ...
        if self.recurring_cost_override is not None:
            ...
            raise TypeError('Missing Communication recurring cost model for group ' + self.servicer.group + ' .')
    ...
    def get_non_recurring_cost(self):
        ...
        if self.non_recurring_cost_override is not None:
            ...
            raise TypeError('Missing Communication non recurring cost model for group ' + self.servicer.group + ' .')
