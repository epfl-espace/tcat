...
class GenericPhase:
    ...
    def __str__(self):
        ...
        return (str(self.ID)
                ...
                + "\n\tReference Satellite Orbit: " + orbit_string(update_orbit(self.spacecraft_snapshot.reference_satellite.get_default_orbit(),self.spacecraft_snapshot.current_orbit.epoch))
